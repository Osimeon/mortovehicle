...
/**
 * This is the model class for table "mortocyle_database.approved_costs".
 *
 * The followings are the available columns in table 'mortocyle_database.approved_costs':
 ...
 */
class ApprovedCosts extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ApprovedCosts the static model class
	 */
	...
	{
		return 'mortocyle_database.approved_costs';
	}
