 ...
 */
class VehicleAggregate extends CActiveRecord
{
	/**
	...
	{
		return 'vehicle_dbms.average_analysis_report';
	}
	...
	public function relations()
	{
		...
		return array(
			'details' => array(self::BELONGS_TO, 'VehicleDetails', 'reg_no'),
		);
	}
