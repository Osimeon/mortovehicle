...
/**
 * This is the model class for table "vehicle_dbms.vehicle_maintenance_costs_repairs_data_entry".
 *
 * The followings are the available columns in table 'vehicle_dbms.vehicle_maintenance_costs_repairs_data_entry':
 ...
 */
class VehicleCostsDataEntry extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return VehicleCostsDataEntry the static model class
	 */
	...
	{
		return 'vehicle_dbms.vehicle_maintenance_costs_repairs_data_entry';
	}
	...
	public function rules()
	{
		...
		return array(
			array('odometer_reading, analysis_period', 'numerical', 'integerOnly'=>true),
			...
			array('reg_no, service_date, oil_lubricant_type, oil_lubricant_quantity, oil_lubricant_total_cost, outsource_material, outsource_material_cost, outsource_labour_total_cost, description_of_ourtsource_work_performed, odometer_reading, duration_week, analysis_period, cost_rec_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'description_of_ourtsource_work_performed' => 'Description Of Work Performed',
