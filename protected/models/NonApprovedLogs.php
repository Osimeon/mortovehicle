...
/**
 * This is the model class for table "mortocyle_database.non_approved_logs".
 *
 * The followings are the available columns in table 'mortocyle_database.non_approved_logs':
 ...
 */
class NonApprovedLogs extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return NonApprovedLogs the static model class
	 */
	...
	{
		return 'mortocyle_database.non_approved_logs';
	}
