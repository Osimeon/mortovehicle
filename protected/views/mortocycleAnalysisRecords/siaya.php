...
<h3>Siaya Office Cumilative Expenditure Summary</h3>
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'reports-grid',
...
<h3>Siaya Office Fuel Consumption</h3>
<?php 
...
<h3>Siaya Office Mantainance Cost Per Mortobike</h3>
...
<h3>Siaya Office Mantainance Cost (Kshs)</h3>
<?php 
$gridWidget = $this->widget('application.extensions.groupgridview.GroupGridView', array(
	'id' => 'grid1',
	'dataProvider'=>$omaint,
...
<h3>Siaya Office Total Cost (Kshs)</h3>
<?php 
$gridWidget = $this->widget('application.extensions.groupgridview.GroupGridView', array(
	'id' => 'grid1',
	'dataProvider'=>$otcost,
...
<h3>Siaya Mortocycle Summary Report</h3>
