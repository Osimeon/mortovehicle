...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'vehicle-costs-data-entry-form',
	...
	<div class="row">
        ...
        <?php echo $form->dropDownList($model,'reg_no', CHtml::listData(VehicleDetails::model()->findAll(), 'reg_no', 'reg_no'),array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'oil_lubricant_quantity',array('placeholder'=>'Enter Oil Quantity In Litres',)); ?>
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'description_of_ourtsource_work_performed',array('rows'=>6, 'cols'=>50, 'placeholder'=>'Describe Work Performed E.g. Washing, Service ')); ?>
