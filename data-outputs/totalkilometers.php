...
<title>Kilometers Covered</title>
</head>
...
<?php if (isset($results)): ?>
	<table cellspacing="0" id="statsTable" align="center">
		<caption>Kilometers Covered</caption>
			<colgroup>
				<col id="RegNumber" />
				<col id="TotalKilometers" />
			</colgroup>
			<thead id="statsHead">
				<tr>
					<th id="statsHead" scope="col">Registration Number</th>
					<th scope="col">Total Kilometers Covered</th>
				</tr>
			</thead>
			<tbody>
				<?php foreach ($results as $resultssearch): ?>
					<tr class="odd">
						...
						<td><?php echo number_format($resultssearch ['tkms'],2); ?></td>
					</tr>
				<?php endforeach; ?>
			</tbody>
		</table>
